...
global aes_256_cbc_encrypt
global aes_256_cbc_decrypt

section .text

; RCX = uint8_t block[16]
; RDX = uint8_t key[16]
; R8  = uint8_t iv[16]
; R9  = uint8_t result[16]
...
aes_256_cbc_encrypt:
	...
	movdqu xmm14, [rdx] ; First 16 bytes of the key
	movdqu xmm15, [r8]	; IV
...
start_aes_enc:
	...
	pxor xmm0, xmm15
	movdqu xmm15, [rdx + 16] ; Last 16 bytes of the key
...
aes_256_cbc_decrypt:
	...
	movdqu xmm14, [rdx + 16]	; Last 16 bytes of the key
	aesimc xmm14, xmm14
...
start_aes_dec:
	...
	movdqu xmm15, [rdx] 		; First 16 bytes of the key
